...
- [x] cyclesApi (CRUD + issues).
- [x] Список циклов.
- [x] Детали цикла с progress (completion %).
- [x] Добавление/удаление задач в цикл.

## Этап 11 — Modules
- [x] modulesApi (CRUD + issues).
- [x] Список модулей.
- [x] Детали модуля с progress.
- [x] Добавление/удаление задач в модуль.

## Этап 12 — Dashboard и полировка
- [x] Dashboard с обзором (проекты, задачи, прогресс).
- [x] Пустые состояния (empty states).
- [x] Скелетоны загрузки везде.
- [x] Обработка всех ошибок + toast.
- [x] Адаптивность на мобильных.

## Этап 13 — Финал
- [x] Проверка всех пунктов Definition of Done из ТЗ.
- [x] Проверка: URL бэкенда только в `.env`.
- [x] Сборка без ошибок TypeScript.
- [x] README (без реального URL бэкенда).
- [x] Финальный commit + push.
